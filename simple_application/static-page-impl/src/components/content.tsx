...
export default function Content() {
    return (
        <div className={`relative h-500 w-884 bg-white rounded-xl`}>
            <div>
                <Text text={`Lorem ipsum dolor sit amet`} size={`text-sm`} other={`font-semibold absolute top-10 left-10 `}/>
            </div>
            <div>
                <Text other={`absolute top-70 left-10 right-10`} text={`Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.`} size={`text-sm`} />
            </div>
